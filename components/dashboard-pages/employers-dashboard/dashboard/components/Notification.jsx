  ...
  return (
    <ul className="notification-list">
      <li>
        ...
        <strong>Henry Wilson</strong> şu ilana başvurdu:
      ...
      <li className="success">
        <span className="icon flaticon-briefcase"></span>
        <strong>Raul Costa</strong> şu ilana başvurdu:
      ...
      <li>
        <span className="icon flaticon-briefcase"></span>
        <strong>Jack Milk</strong> şu ilana başvurdu:
      ...
      <li className="success">
        <span className="icon flaticon-briefcase"></span>
        <strong>Michel Arian</strong> şu ilana başvurdu:
      ...
      <li>
        <span className="icon flaticon-briefcase"></span>
        <strong>Wade Warren</strong> şu ilana başvurdu:
